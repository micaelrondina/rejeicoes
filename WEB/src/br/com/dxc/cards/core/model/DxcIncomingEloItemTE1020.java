...
public class DxcIncomingEloItemTE1020 extends IncomingBaseDescriCodigos {
	...
	private BigDecimal vlDestino;
	@Description("CD_MOEDA_")
	private String cdMoedaDestino;
	private BigDecimal vlOrigem;
	@Description("CD_MOEDA_")
	...
	public BigDecimal getVlDestino() {
		return vlDestino;
	}
	public void setVlDestino(BigDecimal vlDestino) {
	...
	public BigDecimal getVlOrigem() {
		return vlOrigem;
	}
	public void setVlOrigem(BigDecimal vlOrigem) {
